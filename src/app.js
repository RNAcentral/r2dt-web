...
class R2DTWidget extends HTMLElement {
    ...
    renderSvg(svgContent) {
        ...
        sentence.classList.add('r2dt-source-template-text');
        sentence.innerHTML = (!this.template || !this.source)
          ? `Generated by <a href="https://github.com/RNAcentral/r2dt" target="_blank">R2DT</a>. <a href="https://rnacentral.org/help/secondary-structure" target="_blank">Learn more →</a>`
          : this.template === 'R2R'
            ? `Generated by <a href="https://github.com/RNAcentral/r2dt" target="_blank">R2DT</a> using the <i>${this.template}</i> software. <a href="https://rnacentral.org/help/secondary-structure" target="_blank">Learn more →</a>`
            : `Generated by <a href="https://github.com/RNAcentral/r2dt" target="_blank">R2DT</a> using the <i>${this.template}</i> template provided by ${this.sourceLink(this.source)}. <a href="https://rnacentral.org/help/secondary-structure" target="_blank">Learn more →</a>`;
