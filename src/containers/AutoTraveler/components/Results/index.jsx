            ...
            <div className="row" key={`results-div`}>
              <div className="col-sm-12">
                ...
                <p className="text-muted mt-3">
                  Generated by <a className="custom-link" href="https://github.com/RNAcentral/auto-traveler" target="_blank">auto-traveler</a> using the <a className="custom-link" href="https://rnacentral.org/search?q=secondary_structure_model:&quot;HS_LSU_3D&quot;" target="_blank">HS_LSU_3D</a> template provided by <a className="custom-link" href="http://apollo.chemistry.gatech.edu/RiboVision/" target="_blank">RiboVision</a>. <a className="custom-link" href="https://rnacentral.org/help/secondary-structure" target="_blank">Learn more →</a>
                </p>
