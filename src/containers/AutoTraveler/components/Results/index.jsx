            ...
            <div className="row" key={`results-div`}>
              <div className="col-sm-12">
                ...
                <p className="text-muted mt-3">
                  Generated by <a className="custom-link" style={{color: linkColor}} href="https://github.com/RNAcentral/auto-traveler" target="_blank">auto-traveler</a> using the <a className="custom-link" style={{color: linkColor}} href="https://rnacentral.org/search?q=secondary_structure_model:&quot;HS_LSU_3D&quot;" target="_blank">HS_LSU_3D</a> template provided by <a className="custom-link" style={{color: linkColor}} href="http://apollo.chemistry.gatech.edu/RiboVision/" target="_blank">RiboVision</a>. <a className="custom-link" style={{color: linkColor}} href="https://rnacentral.org/help/secondary-structure" target="_blank">Learn more →</a>
                </p>
                <small className="text-muted">
                  Template lineage: cellular organisms; Eukaryota; Opisthokonta; Metazoa; Eumetazoa; Bilateria;
                  Deuterostomia; Chordata; Craniata; Vertebrata; Gnathostomata; Teleostomi; Euteleostomi; Sarcopterygii;
                  Dipnotetrapodomorpha; Tetrapoda; Amniota; Mammalia; Theria; Eutheria; Boreoeutheria; Euarchontoglires;
                  Primates; Haplorrhini; Simiiformes; Catarrhini; Hominoidea; Hominidae; Homininae; Homo; Homo sapiens
                </small>
                <p className="mt-3">
