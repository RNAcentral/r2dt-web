              ...
              <div className="col-sm-12">
                ...
                <span style={title}>Secondary structure </span>
                {
                  (this.props.template === "error" || this.props.source === "error") ? <p className="text-muted mt-3">
                    ...
                    Generated by <a className="custom-link" style={{color: linkColor}} href="https://github.com/RNAcentral/r2dt" target="_blank">R2DT</a>,
                    using the {this.props.template} template provided by {this.props.source}. <a className="custom-link" style={{color: linkColor}} href="https://rnacentral.org/help/secondary-structure" target="_blank">Learn more →</a>
                  </p>
                }
