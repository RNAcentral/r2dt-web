            ...
            <div className="row" key={`results-div`}>
              <div className="col-sm-12">
                ...
                <div className="btn-group mt-3 mb-3" role="group" aria-label="button options">
                  <button className="btn btn-outline-secondary" style={{fontSize: fixCss}} onClick={() => this.props.toggleColors(this.props.svg)}><span className="btn-icon"><MdColorLens size="1.3em"/></span> Toggle colours</button>
                  <button className="btn btn-outline-secondary" style={{fontSize: fixCss}} onClick={() => this.props.toggleNumbers(this.props.svg)}><span className="btn-icon"><AiOutlineFieldNumber size="1.3em"/></span> Toggle numbers</button>
                  <button className="btn btn-outline-secondary" style={{fontSize: fixCss}} onClick={() => this.downloadPNG()}><span className="btn-icon"><RiImage2Line size="1.3em"/></span> Save PNG</button>
                  <button className="btn btn-outline-secondary" style={{fontSize: fixCss}} onClick={() => this.props.downloadSVG(this.props.jobId)}><span className="btn-icon"><RiFileCodeLine size="1.3em"/></span> Save SVG</button>
                </div>
                <ReactSVGPanZoom
                  width={width}
                  height={height}
