            ...
            <div className="row" key={`results-div`}>
              <div className="col-sm-12">
                ...
                <div className="btn-group mt-3 mb-3" role="group" aria-label="button options">
                  <button className="btn btn-outline-secondary" style={{fontSize: fixCss}} onClick={() => this.props.toggleColors(this.props.svg)}>Toggle colours</button>
                  <button className="btn btn-outline-secondary" style={{fontSize: fixCss}} onClick={() => this.props.toggleNumbers(this.props.svg)}>Toggle numbers</button>
                  ...
                  <button className="btn btn-outline-secondary" style={{fontSize: fixCss}} onClick={() => this.downloadPNG()}>Save PNG</button>
                </div>
                <ReactSVGPanZoom
                  width={width}
                  height={height}
