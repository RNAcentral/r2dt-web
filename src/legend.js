export function r2dtLegend(template, source) {
    ...
    const sentence = (!template || !source)
        ...
        : template === 'R2R'
            ? `Generated by <a href="https://github.com/RNAcentral/r2dt" target="_blank">R2DT</a> using the <i>${template}</i> software. <a href="https://rnacentral.org/help/secondary-structure" target="_blank">Learn more →</a>`
            : `Generated by <a href="https://github.com/RNAcentral/r2dt" target="_blank">R2DT</a> using the <i>${template}</i> template provided by ${getSourceLink(source)}. <a href="https://rnacentral.org/help/secondary-structure" target="_blank">Learn more →</a>`;

    return `
        <button class="r2dt-legend-toggle-btn" aria-expanded="true" aria-controls="r2dt-legend-content">
            <span class="r2dt-legend-header">Secondary structure notes</span>
            <span class="r2dt-arrow-icon">&#9660;</span>
        </button>
        <div class="r2dt-legend-content" id="r2dt-legend-content">
