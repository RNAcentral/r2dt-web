...
export function r2dtLegend(template, source) {
    ...
    return `
        <button class="r2dt-legend-toggle-btn" aria-expanded="false" aria-controls="r2dt-legend-content">
            <span class="r2dt-legend-header">Show legend</span>
            <span class="r2dt-arrow-icon">&#9654;</span>
        </button>
        <div class="r2dt-legend-content r2dt-hidden" id="r2dt-legend-content">
